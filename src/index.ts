...
import studentAdminRoutes from './routes/admin/studentRoutes'
import leaveAdminRoutes from './routes/admin/leaveRoutes'
...
app.use('/api/admin/leaves', leaveAdminRoutes)  // This handles /api/admin/leaves/...
